...
// sm covers every mobile pill in the Explore flow (list cards and the
// map's selected-place preview panel) — kept to one size so they read as
// one consistent system (#58). md is reserved for the larger, deliberately
// more prominent contexts: desktop list cards and the detail page's own
// pill row.
const SIZE_STYLES = {
